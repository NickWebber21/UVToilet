...
//
//        val: the value to print (can be a variable name OR a string of text within double quotes)  
//
//        example call:
//            int numVal = 6;
//            Serial.print(“\nThe variable is: ”);
//            Serial.print(numVal); //Prints the following to the Arduino IDE serial monitor:
//                                      "The variable is: 6"
//**********************************************************************************************************
//
//**********************************************************************************************************
...
//**********************************************************************************************************
//
//  (i) motorSpeed(m,p); --> 2 arguments:
//          m = motor number 1,2,3,or use 4 for all
//          p = speed in percent, -100 to 100 (use 0 to stop the motor)
//          
//          example call:
//            motorSpeed(2,67);  //set motor 2 speed to 67% of full power in forward direction 
//**********************************************************************************************************
//
//**********************************************************************************************************
